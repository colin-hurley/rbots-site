...
<p align="center"><a href="..rbots/files/rbots-tutorials.zip" name="Download tutorials">Download tutorials</a></p>

<table width="100%">
<tr><td width="20%"></td><td width="80%"><h3><a href="tutorial-1.html">Adding Rbots 0.30 to a multiplayer level</a></h3></td></tr>
<tr><td width="20%"></td><td width="80%"><h4>
1. Introduction<br>
2. Getting started<br>
3. Putting it all together<br>
4. Laying down the paths<br>
5. Adding the bots<br>
6. Appendix<br>
</h4></td></tr></table>

<p>
<table width="100%">
<tr><td width="20%"></td><td width="80%"><h3><a href="tutorial-2.html">Creating new bots</a></h3></td></tr>
<tr><td width="20%"></td><td width="80%"><h4>
1. Introduction<br>
2. Getting started<br>
3. Putting it all together<br>
...
<p>
<table width="100%">
<tr><td width="20%"></td><td width="80%"><h3><a href="tutorial-3.html">Improving performance</a></h3></td></tr>
<tr><td width="20%"></td><td width="80%"><h4>
1. Introduction<br>
2. Getting started<br>
3. Better node placement<br>
4. Special path nodes<br>
5. Custom cogs<br>
</h4></td></tr></table>
